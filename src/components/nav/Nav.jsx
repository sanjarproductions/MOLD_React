          ...
          <div className="flex">
            ...
            <div className="lang">
              <img
                src={uzLang}
                alt=""
                className="lang_uz_img"
                onClick={() => changeLang("uz")}
              />
              <img
                src={ruLang}
                alt=""
                className="lang_ru_img"
            ...
            <a
              href="mailto: erkinjon.hodjaev@gmail.com"
              className="email contact-method"
            >
              <img src={emailContact} alt="" /> erkinjon.hodjaev@gmail.com
            </a>
          </div>
        </Container>
      </nav>
